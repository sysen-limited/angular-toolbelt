 ...
 * known as [documentation application](http://en.wikipedia.org/wiki/Partial_application), as
...
function adjustMatcher(matcher) {
  if (matcher === 'self') {
    ...
    // Match entire URL / disallow documentation matches.
 ...
 * @param {string=} onload Expression to evaluate when a new documentation is loaded.
 *
